<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="text-center text-dark mb-4">
        ...
        <h3 class="fs-28 fw-500" style="color: #1B3A5C;">{{ translate('Item added to your cart!')}}</h3>
    </div>
    ...
    <div class="media mb-1">
        ...
        <div class="media-body mt-2 text-left d-flex flex-column justify-content-between">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-9">
                    <div class="fs-16 fw-700" style="color: #c45c26;">
                        <strong>
                            @php 
    ...
    <div class="row gutters-5">
        <div class="col-sm-6">
            <button class="btn btn-cta-add-to-cart mb-3 mb-sm-0 btn-block" data-dismiss="modal">{{ translate('Back to shopping')}}</button>
        </div>
        <div class="col-sm-6">
            <a href="{{ route('cart') }}" class="btn btn-cta-buy-now mb-3 mb-sm-0 btn-block">{{ translate('Proceed to Checkout')}}</a>
        </div>
    </div>
</div>
