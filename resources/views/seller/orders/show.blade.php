        ...
        <div class="card-body">
            <div class="row gutters-5 mb-5">
                ...
                <div class="col-md-3 ml-auto">
                    ...
                    <input id="update_payment_status" type="text" class="form-control" value="{{ translate(ucfirst(str_replace('_', ' ', $payment_status))) }}" disabled>
                </div>
                <div class="col-md-3 ml-auto">
            ...
            <div class="row gutters-5 mt-2">
                <div class="col text-md-left text-center">
                    ...
                    @if ($order->manual_payment && is_array(json_decode($order->manual_payment_data, true)))
                        ...
                        {{ translate('Name') }}: {{ ucfirst(str_replace('_', ' ', json_decode($order->manual_payment_data)->name)) }},<br>
                        {{ translate('Amount') }}:
                        {{ single_price(json_decode($order->manual_payment_data)->amount) }},<br>
                        {{ translate('Transaction ID') }}: {{ json_decode($order->manual_payment_data)->trx_id }}
                        <br>
                        @if(json_decode($order->manual_payment_data)->name != 'cash_on_delivery')
