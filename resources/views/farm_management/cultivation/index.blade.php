              ...
              <div class="card-body" >
                <form action="{{route('cultivation.store')}}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="date" id="expected_Date_of_Harvest_after_Sowing" name="expected_Date_of_Harvest_after_Sowing">
                        </div>
                    </div>
                    {{-- Sowing Date --}}
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="number" id="seed_Quantity_unit" name="seed_Quantity_unit" min="1" max="999999999">
                        </div>
                    </div>
